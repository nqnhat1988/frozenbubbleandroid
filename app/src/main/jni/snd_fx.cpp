...
//---------------------------------------------------------------------------
{
    ...
    if (pszMidiMacro[0] == '0') {
        ...
        if ((cData1 == 'z') || (cData1 == 'Z')) {
            ...
            if ((cData1 >= '0') && (cData1 <= '9')) dwParam += (cData1 - '0') << 4; else if ((cData1 >= 'A') && (cData1 <= 'F')) dwParam +=
                                                                                                                                         (cData1 - 'A' + 0x0A)
                                                                                                                                                 << 4;
            if ((cData2 >= '0') && (cData2 <= '9')) dwParam += (cData2 - '0'); else if ((cData2 >= 'A') && (cData2 <= 'F')) dwParam += (cData2 - 'A' + 0x0A);
        }
...
//----------------------------------------------------------------------------------------------------------
{
    ...
    if ((nJumpOrder < nStartOrder) || (nJumpRow >= PatternSize[nStartOrder])
        || (!Patterns[nStartOrder]) || (nStartRow >= 256) || (nJumpRow >= 256))
        return FALSE;
