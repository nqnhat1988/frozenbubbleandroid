                                ...
                                if (!infobyte[i]) {
                                    ...
                                    if (info & 0x04) {
                                        ...
                                        switch (efx) {
                                            ...
                                            case 3:
                                                if (eval) {
                                                    cmd.command = CMD_ARPEGGIO;
                                                    cmd.param = eval;
                                                }
                                                break;
                                                // 4: Portamento Up
                                            case 4:
                                                cmd.command = CMD_PORTAMENTOUP;
                                                cmd.param = (eval >= 0xe0) ? 0xdf : eval;
                                                break;
                                                // 5: Portamento Down
                                            case 5:
                                                cmd.command = CMD_PORTAMENTODOWN;
                                                cmd.param = (eval >= 0xe0) ? 0xdf : eval;
                                                break;
                                                // 6: Tone Portamento
                                            case 6:
                                    ...
                                    if (info & 0x02) {
                                        ...
                                        switch (efx) {
                                            ...
                                            case 1:
                                                if (eval == 0xff) break;
                                                eval = (eval + 3) >> 2;
                                                if (eval > 0x0f) eval = 0x0f;
                                                cmd.command = CMD_VOLUMESLIDE;
                                                cmd.param = eval << 4;
                                                break;
                                                // 2: Vol Slide Down
                                            case 2:
                                            ...
                                            case 7:
                                                if (!cmd.volcmd) {
                                                    cmd.volcmd = VOLCMD_PANNING;
                                                    cmd.vol = (eval + 3) >> 2;
                                                }
                                                else {
                                                    cmd.command = CMD_PANNING8;
                                                    cmd.param = eval;
                                                }
                                                break;
                                                // 8: Pan Slide Left
                                ...
                                for (UINT ich = 0; ich < m_nChannels; ich++)
                                    if (!p[ich].command) {
                                        if (speed) {
                                            ...
                                            speed = 0;
                                        } else if ((modtempo >= 32) && (modtempo < 256)) {
