    ...
    while (nTrkSize--) {
            ...
            // effect
        {
            ...
            switch (command) {
                ...
                case 0x0A:
                    if (command == 0x0A) command = CMD_TONEPORTAVOL;
                case 0x0B:
                    if (command == 0x0B) command = CMD_VIBRATOVOL;
