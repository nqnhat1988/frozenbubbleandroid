...
public interface Opponent {
     ...
     * @param compressor
     */
    void compute(int currentColor, int nextColor, int compressor);
     ...
     */
    int getAction(double currentDirection);
     ...
     * @return
     */
    double getExactDirection(double currentDirection);
